...
figure(1)
topoplot(ERDfeetMuCAR,chanlocs16,'maplimits','maxmin');%limitsCARMU);
colorbar
title('Emily: \mu-band of Car filtered Feet ')
saveas(figure(1), 'emily_mu_car_feet.png')

figure(2)
topoplot(ERDhandsMuCAR,chanlocs16,'maplimits','maxmin');%limitsCARMU);
colorbar
title('Emily: \mu-band of Car filtered Hands ')
saveas(figure(2), 'emily_mu_car_hands.png')
...
figure(3)
topoplot(ERDfeetMuLAP,chanlocs16,'maplimits','maxmin');%limitsLAPMU);
colorbar
title('Emily: \mu-band of Lap filtered Feet ')
saveas(figure(3), 'emily_mu_lap_feet.png')

figure(4)
topoplot(ERDhandsMuLAP,chanlocs16,'maplimits','maxmin');%limitsLAPMU);
colorbar
title('Emily: \mu-band of Lap filtered Hands ')
saveas(figure(4), 'emily_mu_lap_hands.png')
...
figure(5)
topoplot(ERDfeetBetaCAR,chanlocs16,'maplimits','maxmin');%limitsCARbeta);
colorbar
title('Emily: \beta-band of Car filtered Feet ')
saveas(figure(5), 'emily_beta_car_feet.png')

figure(6)
topoplot(ERDhandsBetaCAR,chanlocs16,'maplimits','maxmin');%limitsCARbeta);
colorbar
title('Emily: \beta-band of Car filtered Hands ')
saveas(figure(6), 'emily_beta_car_hands.png')
...
figure(7)
topoplot(ERDfeetBetaLAP,chanlocs16,'maplimits','maxmin');%limitsLAPbeta);
colorbar
title('Emily: \beta-band of Lap filtered Feet ')
saveas(figure(7), 'emily_beta_lap_feet.png')

figure(8)
topoplot(ERDhandsBetaLAP,chanlocs16,'maplimits','maxmin');%limitsLAPbeta);
colorbar
title('Emily: \beta-band of Lap filtered Hands ')
saveas(figure(8), 'emily_beta_lap_hands.png')